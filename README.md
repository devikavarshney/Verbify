...
## Proposed Solution  
* We wish to implement a prototype that analyses the video in online video calls and detects sign language when it is being used.
* The signs are then converted to audio for everyone else in the meeting to be able to communicate with ease, without any lag or communication gaps.
* In the future, our prototype will also integrate with the audio calls through the phone and will interpret the sign language and convert them to voice.
